...
export const metadata: Metadata = {
    ...
    description: "هدايا مكتبية فاخرة للشركات في جدة: أقلام معدنية، دفاتر جلدية، أجندات، ومجموعات هدايا بشعار شركتك. طباعة ليزر وتطريز. أسعار تبدأ من 2 ريال. خصومات الكميات.",
    keywords: [
        "هدايا مكتبية",
        "أقلام دعائية جدة",
        "دفاتر شركات",
...
const FAQS = [
    {
        question: "كم سعر طباعة 500 قلم بالشعار في جدة؟",
        answer: "أقلام بلاستيكية عادية من 2 ريال/قطعة = 1,000 ريال. أقلام بلاستيكية فاخرة من 4 ريال = 2,000 ريال. أقلام معدنية من 8 ريال = 4,000 ريال. السعر يشمل الطباعة، تكلفة الكليشيه 100 ريال لمرة واحدة.",
    },
    {
        question: "ما أفضل الهدايا المكتبية للعملاء VIP؟",
        answer: "ننصح بمجموعة: قلم معدني + دفتر جلدي A5 + علبة فاخرة، السعر من 60 ريال/مجموعة. أو أجندة جلدية بختم ذهبي من 40 ريال. للعملاء الأهم: مجموعة كاملة مع حقيبة من 150 ريال.",
    },
    {
        question: "هل يمكن طباعة أكثر من لون على القلم؟",
        answer: "طباعة الليزر لون واحد (الأكثر شيوعاً). للألوان المتعددة نستخدم طباعة UV (حتى 4 ألوان) أو silk printing. التكلفة الإضافية 0.5 ريال/لون/قطعة.",
    },
    {
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl text-white/90 mb-6 leading-relaxed font-medium">
                                ...
                                شركتك وتراها العين كل يوم. ولتكتمل الهدية، يمكنك إرفاق <Link href="/promotional-gifts/tech-gadgets" className="text-amber-200 underline">فلاش ميموري</Link> يحمل ملف تعريف شركتك. في بوابة الرواج نوفر مئات الخيارات بأسعار تبدأ
                                من 2 ريال للقطعة، مع طباعة ليزر عالية الجودة.
                            </p>
                            ...
                            <div className="grid grid-cols-3 gap-6 pt-8 border-t border-white/10">
                                <div className="text-center">
                                    ...
                                    <div className="text-xs text-white/60">ريال/قلم</div>
                                </div>
                                <div className="text-center">
