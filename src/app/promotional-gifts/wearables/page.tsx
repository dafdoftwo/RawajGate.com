...
const WEARABLE_TYPES = [
    { name: "تيشرت قطن", desc: "180 جرام، مريح للموظفين", price: "من 20 ريال/قطعة", icon: Shirt },
    { name: "بولو شيرت", desc: "ياقة كلاسيكية، مظهر رسمي", price: "من 35 ريال/قطعة", icon: Shirt },
    { name: "كاب / قبعة", desc: "قطن أو بوليستر، أحجام متعددة", price: "من 12 ريال/قطعة", icon: HardHat },
];
...
const FAQS = [
    {
        question: "كم سعر 100 تيشرت بالشعار؟",
        answer: "تيشرت قطن 180 جرام + تطريز شعار صغير (8×8 سم): من 28 ريال/قطعة = 2,800 ريال. مع طباعة حرارية للشعار الكبير: 25 ريال/قطعة = 2,500 ريال.",
    },
    {
