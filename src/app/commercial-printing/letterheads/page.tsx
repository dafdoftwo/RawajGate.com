...
const PAPER_OPTIONS = [
    { name: "ورق 100 جرام", desc: "الأكثر شيوعاً للمراسلات العادية", price: "من 120 ريال/500 ورقة" },
    { name: "ورق 120 جرام", desc: "أثقل للعقود والمستندات الرسمية", price: "من 150 ريال/500 ورقة" },
    { name: "ورق كتان Linen", desc: "ملمس فاخر للشركات الراقية", price: "من 200 ريال/500 ورقة" },
];

const FAQS = [
    {
        question: "كم سعر 1000 ورقة ليترهيد؟",
        answer: "ورق 100 جرام: من 200 ريال. ورق 120 جرام: من 250 ريال. ورق كتان: من 350 ريال. السعر يشمل الطباعة وجه واحد ملون. التصميم مجاني.",
    },
    {
        question: "هل تطبعون على وجهين؟",
        answer: "نعم، طباعة الوجه الثاني (معلومات الاتصال، شروط، خريطة) تضيف 50% على السعر. ننصح بها للعقود والفواتير.",
    },
];
