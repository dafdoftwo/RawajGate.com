...
export const metadata: Metadata = {
    ...
    description: "طباعة دفاتر NCR كربونية (نسخ ذاتية) في جدة: فواتير، إيصالات، طلبات، وسندات قبض. 2-4 نسخ بألوان مختلفة. ترقيم وتثقيب. أسعار تبدأ من 8 ريال/دفتر.",
    keywords: ["دفاتر NCR", "فواتير كربونية", "إيصالات", "سندات قبض", "NCR books jeddah", "طباعة نسخ ذاتية"],
};

const NCR_TYPES = [
    { name: "دفتر نسختين (أبيض + أصفر)", copies: "2 نسخ", price: "من 8 ريال/دفتر 50 ورقة", icon: BookCopy },
    { name: "دفتر 3 نسخ (أبيض + أصفر + وردي)", copies: "3 نسخ", price: "من 12 ريال/دفتر 50 ورقة", icon: Layers },
    { name: "دفتر 4 نسخ (أبيض + أصفر + وردي + أخضر)", copies: "4 نسخ", price: "من 16 ريال/دفتر 50 ورقة", icon: Receipt },
];
...
const FAQS = [
    ...
    {
        question: "كم سعر 100 دفتر فواتير NCR؟",
        answer: "دفتر 50 ورقة نسختين: 8 ريال × 100 = 800 ريال. ثلاث نسخ: 12 ريال × 100 = 1,200 ريال. السعر يشمل الطباعة والترقيم والتثقيب والغلاف الكرتوني.",
    },
    {
